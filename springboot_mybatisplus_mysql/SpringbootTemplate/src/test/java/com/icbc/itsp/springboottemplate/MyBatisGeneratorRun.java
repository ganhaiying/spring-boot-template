...
public class MyBatisGeneratorRun {
    ...
    //数据库连结信息(需要根据项目修改)
    private final String dbUrl = "jdbc:mysql://192.168.44.128:3306/general_test?useUnicode=true&characterEncoding=utf8";
    private final String driver = "com.mysql.cj.jdbc.Driver";
    private final String userName = "root";
    private final String password = "rootroot";

    //项目名(需要根据项目修改)
    private final String projectName = "springboottemplate";
    //指定包名(需要根据项目修改)
    private final String packageName = "com.icbc.itsp.springboottemplate";
    //controller基础类
    ...
    //指定生成的表名(需要根据项目修改)
    private final String[] tableNames = new String[]{"interface_info", "case_info"};
...
//        int index = path.indexOf(projectName);
        return "F:/gitItems/myItems/FrameTemplate/springboot_mybatisplus_mysql/" + projectName + "/src/main/java/";
    }
    /**
     * 策略配置(需要根据项目修改)
     * @param tableNames 表名
